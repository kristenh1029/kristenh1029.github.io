...
function uploadFile() {
    ...
    axios.post("/api/uploadCoverImage", formData, {
...
<template >
    ...
    <div class="heading text-center font-bold text-2xl m-5 text-gray-800">Create Pattern</div>
  ...
  <div class="editor mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl">
    ...
    v-model="form.title">
    <textarea class="description bg-gray-100 sec p-3 h-60 border border-gray-300 outline-none" spellcheck="false" placeholder="Share your description..."
